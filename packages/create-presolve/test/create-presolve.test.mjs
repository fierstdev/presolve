...
assert.equal(manifest.dependencies.presolve, "npm:@presolve/framework@0.2.0-beta.10");
assert.equal(manifest.devDependencies["@presolve/typescript-authority"], "0.2.0-beta.10");
