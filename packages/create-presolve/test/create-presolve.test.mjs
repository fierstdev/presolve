...
assert.equal(manifest.dependencies.presolve, "npm:@presolve/framework@0.2.0-beta.17");
assert.equal(manifest.devDependencies["@presolve/typescript-authority"], "0.2.0-beta.17");
