...
for (const route of ["app/layout.tsx", "app/routes/index.tsx", "app/routes/docs/index.tsx", "app/routes/docs/getting-started.tsx"]) {
...
assert.equal(manifest.dependencies.presolve, "npm:@presolve/framework@0.2.0-beta.2");
assert.equal(manifest.devDependencies["@presolve/typescript-authority"], "0.2.0-beta.2");
...
assert.match(readFileSync(join(target, "README.md"), "utf8"), /dist\/styles/);
