...
assert.equal(manifest.dependencies.presolve, "npm:@presolve/framework@0.2.0-beta.24");
assert.equal(manifest.devDependencies["@presolve/cli"], "0.2.0-beta.24");
assert.equal(manifest.devDependencies["@presolve/typescript-authority"], "0.2.0-beta.24");
