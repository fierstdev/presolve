...
writeFileSync(join(root, "package.json"), JSON.stringify({
  dependencies: { presolve: "npm:@presolve/framework@0.2.0-beta.26" },
}));
...
assert.equal(readPresolveVersion(root), "0.2.0-beta.26");
assert.deepEqual(inspectWorkspace(vscode), {
  configured: true,
  root,
  cli: executable,
  version: "0.2.0-beta.26",
  message: "Presolve 0.2.0-beta.26 · compiler-owned diagnostics and explanations are available.",
});
