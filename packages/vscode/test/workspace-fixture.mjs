...
writeFileSync(join(root, "package.json"), JSON.stringify({
  dependencies: { presolve: "npm:@presolve/framework@0.2.0-beta.20" },
}));
...
assert.equal(readPresolveVersion(root), "0.2.0-beta.20");
assert.deepEqual(inspectWorkspace(vscode), {
  configured: true,
  root,
  cli: executable,
  version: "0.2.0-beta.20",
  message: "Presolve 0.2.0-beta.20 · compiler-owned diagnostics and explanations are available.",
});
