...
writeFileSync(join(root, "package.json"), JSON.stringify({
  dependencies: { presolve: "npm:@presolve/framework@0.2.0-beta.16" },
}));
...
assert.equal(readPresolveVersion(root), "0.2.0-beta.16");
assert.deepEqual(inspectWorkspace(vscode), {
  configured: true,
  root,
  cli: executable,
  version: "0.2.0-beta.16",
  message: "Presolve 0.2.0-beta.16 · compiler-owned diagnostics and explanations are available.",
});
