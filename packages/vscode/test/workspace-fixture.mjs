...
writeFileSync(join(root, "package.json"), JSON.stringify({
  dependencies: { presolve: "npm:@presolve/framework@0.2.0-beta.13" },
}));
...
assert.equal(readPresolveVersion(root), "0.2.0-beta.13");
assert.deepEqual(inspectWorkspace(vscode), {
  configured: true,
  root,
  cli: executable,
  version: "0.2.0-beta.13",
  message: "Presolve 0.2.0-beta.13 · compiler-owned diagnostics and explanations are available.",
});
