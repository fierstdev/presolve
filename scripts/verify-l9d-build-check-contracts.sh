...
rg --quiet 'run_explicit_build_or_check_v1' crates/ezc_cli/src/main.rs
if rg -n 'read_dir|WalkDir|glob::|parse_file|build_application_semantic_model|generate_|emit_production' crates/ezc_cli/src/build_check_commands.rs; then
