...
rg --quiet 'run_l11_inspect' crates/presolve_cli/src/main.rs
rg --quiet 'run_l11_workspace_graph' crates/presolve_cli/src/main.rs
rg --quiet 'read_tooling_product_v1' crates/presolve_cli/src/main.rs
