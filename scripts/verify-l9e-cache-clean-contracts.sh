...
rg --quiet 'run_project_cache_operation_v1' crates/ezc_cli/src/main.rs
if awk '/^#\[cfg\(test\)\]/{exit} {print}' crates/ezc_cli/src/cache_commands.rs | rg -n 'read_dir|WalkDir|glob::|parse_file|build_application_semantic_model|remove_dir_all'; then
