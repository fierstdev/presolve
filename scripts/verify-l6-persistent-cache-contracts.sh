...
readonly cache_source='crates/ezc_core/src/persistent_cache.rs'
readonly service_source='crates/ezc_core/src/service.rs'
readonly fixture_dir='crates/ezc_core/fixtures/persistent-cache'
...
! rg --quiet 'ezc_parser::|read_to_string|read_to_end|SystemTime|Instant' "$cache_source"
