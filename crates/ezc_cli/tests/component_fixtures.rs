...
fn fixture_unit(paths: &[&str]) -> ezc_core::ApplicationSemanticModel {
    let sources = paths
        .iter()
...
fn component_codes(model: &ezc_core::ApplicationSemanticModel) -> BTreeSet<String> {
...
fn assert_contract_identities(diagnostic: &ezc_core::ComponentDiagnostic, identities: &str) {
