...
pub use intermediate_representation::{
    ...
    IrDominatorTree, IrFunction, IrInstruction, IrInstructionId, IrInstructionKind, IrLoop,
    IrLoopId, IrModule, IrOperand, IrPostDominatorTree, IrStorageId, IrTemplateEntrypoint,
    IrValueId,
};
pub use model::{
