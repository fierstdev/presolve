...
pub use intermediate_representation::{
    ...
    analyze_liveness, analyze_reachability, analyze_reactive_transitive_graph,
    analyze_use_definitions, build_reactive_graph, compute_dominators, compute_post_dominators,
    inspect_dom_nodes, lower_components_to_ir, validate_intermediate_representation,
    ...
    IrReachabilityAnalysis, IrReactiveEdge, IrReactiveEdgeKind, IrReactiveGraph, IrReactiveNode,
