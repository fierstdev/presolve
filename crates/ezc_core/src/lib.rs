...
pub use intermediate_representation::{
    ...
    lower_components_to_ir, optimize_computed_ir, optimize_effect_ir, plan_computed_evaluation,
    validate_context_ir, validate_effect_ir, validate_intermediate_representation,
    ContextConsumerLoadId, ContextIrReport, ContextSourceFunctionId, ContextValueSlotId,
    IntermediateRepresentation, IrBinaryOperation, IrBlock, IrBlockId, IrBranchArm, IrBranchEdge,
    IrCfgCleanupPass, IrCommonSubexpressionEliminationPass, IrComputedEvaluation,
    IrComputedEvaluationPlan, IrConstant, IrConstantFoldingPass, IrConstantPropagationAnalysis,
    IrContextConsumerBinding, IrContextLoad, IrContextSourceEvaluation, IrCopyPropagationPass,
    IrDeadAssignmentAnalysis, IrDeadCodeEliminationPass, IrDefinitionUseAnalysis, IrDomAttribute,
    IrDomAttributeValue, IrDomBinding, IrDomConditional, IrDomEvent, IrDomInspection, IrDomList,
    IrDomNode, IrDomNodeId, IrDomNodeKind, IrDomText, IrDominatorTree, IrEffectCompletion,
    IrEffectExecution, IrFunction, IrInstruction, IrInstructionId, IrInstructionKind,
    ...
    IrOptimizationReport, IrPassManager, IrPostDominatorTree, IrReachabilityAnalysis,
    IrReactiveCycle, IrReactiveCycleAnalysis, IrReactiveEdge, IrReactiveEdgeKind, IrReactiveGraph,
    IrReactiveNode, IrReactiveNodeKind, IrReactiveTransitiveAnalysis, IrSchedulerInspection,
    IrStorage, IrStorageId, IrTemplateEntrypoint, IrUnaryOperation, IrUpdateScheduler, IrUse,
