...
pub use effect::{
    ...
    EffectBody, EffectExecutionPolicy, EffectReactiveAnalysis, EffectSemanticViolation,
    EffectSemanticViolationKind, EffectStatement, EffectStatementKind, EffectValidation,
};
...
pub use intermediate_representation::{
    ...
    lower_components_to_ir, optimize_computed_ir, plan_computed_evaluation,
    ...
    IrComputedEvaluation, IrComputedEvaluationPlan, IrConstant, IrConstantFoldingPass,
    ...
    IrDomNodeKind, IrDomText, IrDominatorTree, IrFunction, IrInstruction, IrInstructionId,
    IrInstructionKind, IrInstructionSimplificationPass, IrLivenessAnalysis, IrLoop, IrLoopId,
    IrModule, IrOperand, IrOptimizationMetrics, IrOptimizationPass, IrOptimizationPassReport,
    IrOptimizationPipeline, IrOptimizationReport, IrPassManager, IrPostDominatorTree,
    IrReachabilityAnalysis, IrReactiveCycle, IrReactiveCycleAnalysis, IrReactiveEdge,
    IrReactiveEdgeKind, IrReactiveGraph, IrReactiveNode, IrReactiveNodeKind,
    IrReactiveTransitiveAnalysis, IrSchedulerInspection, IrStorage, IrStorageId,
    IrTemplateEntrypoint, IrUnaryOperation, IrUpdateScheduler, IrUse, IrUseDefinition,
