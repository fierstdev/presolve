...
pub use intermediate_representation::{
    ...
    IrDomBinding, IrDomEvent, IrDomNode, IrDomNodeId, IrDomNodeKind, IrDomText, IrDominatorTree,
    IrFunction, IrInstruction, IrInstructionId, IrInstructionKind, IrInstructionSimplificationPass,
