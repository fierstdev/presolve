...
pub use intermediate_representation::{
    analyze_definition_uses, analyze_use_definitions, compute_dominators, compute_post_dominators,
    lower_components_to_ir, validate_intermediate_representation, IntermediateRepresentation,
    IrBinaryOperation, IrBlock, IrBlockId, IrBranchArm, IrBranchEdge, IrConstant,
    IrDefinitionUseAnalysis, IrDominatorTree, IrFunction, IrInstruction, IrInstructionId,
    IrInstructionKind, IrLoop, IrLoopId, IrModule, IrOperand, IrPostDominatorTree, IrStorage,
    IrStorageId, IrTemplateEntrypoint, IrUnaryOperation, IrUse, IrUseDefinition,
