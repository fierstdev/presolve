...
pub use intermediate_representation::{
    ...
    plan_computed_evaluation, validate_intermediate_representation, IntermediateRepresentation,
    IrBinaryOperation, IrBlock, IrBlockId, IrBranchArm, IrBranchEdge, IrCfgCleanupPass,
    IrCommonSubexpressionEliminationPass, IrComputedEvaluationPlan, IrConstant,
    IrConstantFoldingPass, IrConstantPropagationAnalysis, IrCopyPropagationPass,
    ...
    IrDomNode, IrDomNodeId, IrDomNodeKind, IrDomText, IrDominatorTree, IrFunction, IrInstruction,
    ...
    IrPostDominatorTree, IrReachabilityAnalysis, IrReactiveCycle, IrReactiveCycleAnalysis,
    IrReactiveEdge, IrReactiveEdgeKind, IrReactiveGraph, IrReactiveNode, IrReactiveNodeKind,
