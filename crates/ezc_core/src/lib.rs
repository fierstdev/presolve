...
pub use intermediate_representation::{
    ...
    IrLivenessAnalysis, IrLoop, IrLoopId, IrModule, IrOperand, IrOptimizationPass,
    IrOptimizationPipeline, IrPassManager, IrPostDominatorTree, IrReachabilityAnalysis, IrStorage,
