...
pub use intermediate_representation::{
    ...
    IrDeadAssignmentAnalysis, IrDeadCodeEliminationPass, IrDefinitionUseAnalysis, IrDominatorTree,
    IrFunction, IrInstruction, IrInstructionId, IrInstructionKind, IrLivenessAnalysis, IrLoop,
    IrLoopId, IrModule, IrOperand, IrOptimizationPass, IrOptimizationPipeline, IrPassManager,
