...
impl FormOwnershipIntegrityKind {
    ...
    pub const fn code(self) -> &'static str {
        match self {
            Self::DuplicateNode => "EZASM1203",
            Self::MissingOwner => "EZASM1204",
            Self::UnknownOwnershipEndpoint => "EZASM1205",
            Self::MultipleOwners => "EZASM1206",
            Self::OwnershipCycle => "EZASM1207",
            Self::UnreachableNode => "EZASM1208",
            Self::UnknownReferenceEndpoint => "EZASM1209",
            Self::ComponentOwnershipMismatch => "EZASM1210",
            Self::FieldFormMismatch => "EZASM1211",
            Self::BindingFieldMismatch => "EZASM1212",
            Self::BindingFormMismatch => "EZASM1213",
            Self::BindingTemplateMismatch => "EZASM1214",
            Self::InvalidCandidatePromoted => "EZASM1215",
            Self::InstanceIdentityInDeclarationGraph => "EZASM1216",
            Self::MissingProvenance => "EZASM1217",
            Self::NonCanonicalOrdering => "EZASM1218",
            Self::GraphIdentityMismatch => "EZASM1219",
        }
    }
}
