...
fn phase_h_freezes_authorities_schemas_and_no_discovery_contract() {
    ...
    assert_eq!(RUNTIME_COMPONENT_ARTIFACT_SCHEMA_VERSION, 8);
    ...
    assert_eq!(component_artifact.schema_version, 8);
    ...
    assert!(runtime.contains("SUPPORTED_COMPONENT_ARTIFACT_SCHEMA_VERSION = 8"));
