    ...
    SemanticCapabilityRegistry {
        ...
        capabilities: vec![
            ...
            deferred(
                ...
                "N6-A Resource declaration and instance-qualified lifecycle products",
                "no compiler-recognized Resource source form or endpoint contract yet",
                "no executable async dependency or cancellation plan yet",
                "no Resource resume policy",
                "no Resource runtime artifact",
                "N6-A deliberately stops before source lowering and runtime admission",
            ),
            deferred(
                "opaque_typescript",
