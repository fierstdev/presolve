# Phase N specifications

Phase N is the planned compiler semantic-capability expansion that follows the
frozen Phase M framework foundation. It is planning-only until an individual
...
* [N3-D serializable Action locals contract](PHASE_N_N3D_SERIALIZABLE_ACTION_LOCALS_CONTRACT.md)
* [N3-E structured serializable Action locals contract](PHASE_N_N3E_STRUCTURED_ACTION_LOCALS_CONTRACT.md)
