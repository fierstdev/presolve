...
N7-A is complete: twelve bounded compiler-owned dynamic accessibility
attributes now carry exact boolean or string type contracts through the
existing template/runtime attribute path. This adds no DOM-discovery or
accessibility runtime authority.
