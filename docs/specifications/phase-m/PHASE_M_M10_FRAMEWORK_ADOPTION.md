...
It rejects untracked generated files as well as tracked changes. Before that
clean-tree assertion, M10-C removes only the exact Form-fixture `.presolve`
caches generated by its inherited M9 evidence.
