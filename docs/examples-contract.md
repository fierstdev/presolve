...
| Forms | forms contract and its core/runtime fixture coverage | listed form source files | existing forms compiler/runtime proof | browser submit/network behavior |
