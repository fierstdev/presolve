...
| 24 | Effects | `effect_field_lowering`; `effect`, `effect_*`, `runtime_effect_*` | Authority-backed decorator-free effect-field source recognition is in progress. Runtime adoption remains gated on cleanup, lifecycle ordering, and cold/resume proof. |
